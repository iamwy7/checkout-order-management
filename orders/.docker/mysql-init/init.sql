...
CREATE TABLE IF NOT EXISTS orders (
    ...
    order_status VARCHAR(10) NOT NULL,        -- order current status, can be updated if needed PENDING, APPROVED, CANCELED   \  idea: dedicated table
...
CREATE TABLE IF NOT EXISTS distribution_centers (
    ...
    dist_cen_status VARCHAR(10) NOT NULL            -- distribuition_center status, can be ACTIVE, INACTIVEe
);
...
INSERT INTO orders (order_id, order_zone, order_state, order_status, order_created_at, order_updated_at) VALUES ('8c8f5d8f-bcec-478c-8d56-5c8390d0f938', 'S1', 'SP', 'PENDING', '2025-01-02 15:04:05', '2025-01-02 15:04:05');
